...
export default async function Content({ sceneSequenceName, sceneIndex, textIndex, isChoiceActive }: Items) {
  console.log(
  ...
  const link = await getNextLink(sceneSequenceName, sceneIndex, textIndex, isChoiceActive)
    ...
    <div className="flex flex-grow flex-col gap-8 justify-center items-center h-full w-full">
      ...
      >
        <Image
          ...
          src={await getImgSrc(sceneSequenceName, sceneIndex)}
          alt="Story page"
          width={500}
          height={300}
          priority
